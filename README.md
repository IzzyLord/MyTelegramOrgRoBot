...
- can be found on [Telegram](https://telegram.dog/Nekone_Org_Bot)

🙄 [@Telegram.Org](https://telegram.dog/Nekone_Org_Bot) **is the only Telegram RoBot, which is using this repository code**. 🙄😬
...
```sh
git clone https://GitHub.com/IzzyLord/MyTelegramOrgRoBot.git
```
